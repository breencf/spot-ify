...
def seed_songs_1():
    ...
    s32=Song(name="Movement 4", artist_id=5, album_id=5, album_track_number=4, audio="https://cb-aa-spotify-clone-songs.s3.amazonaws.com/Floating+Points+-+Promises/03+-+Movement+4.mp3")
    s33=Song(name="Movement 5", artist_id=5, album_id=5, album_track_number=5, audio="https://cb-aa-spotify-clone-songs.s3.amazonaws.com/Floating+Points+-+Promises/03+-+Movement+5.mp3")
    s34=Song(name="Movement 6", artist_id=5, album_id=5, album_track_number=6, audio="https://cb-aa-spotify-clone-songs.s3.amazonaws.com/Floating+Points+-+Promises/03+-+Movement+6.mp3")
    s35=Song(name="Movement 7", artist_id=5, album_id=5, album_track_number=7, audio="https://cb-aa-spotify-clone-songs.s3.amazonaws.com/Floating+Points+-+Promises/03+-+Movement+7.mp3")
    s36=Song(name="Movement 8", artist_id=5, album_id=5, album_track_number=8, audio="https://cb-aa-spotify-clone-songs.s3.amazonaws.com/Floating+Points+-+Promises/03+-+Movement+8.mp3")
    s37=Song(name="Movement 9", artist_id=5, album_id=5, album_track_number=9, audio="https://cb-aa-spotify-clone-songs.s3.amazonaws.com/Floating+Points+-+Promises/03+-+Movement+9.mp3")
