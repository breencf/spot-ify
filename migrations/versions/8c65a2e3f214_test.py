...
Revision ID: 8c65a2e3f214
Revises: 
Create Date: 2022-03-04 17:15:33.657044
...
def upgrade():
    ...
    sa.Column('descripion', sa.String(length=255), nullable=False),
    ...
    sa.Column('audio', sa.VARCHAR(), nullable=False),
    sa.Column('artist_id', sa.Integer(), nullable=False),
